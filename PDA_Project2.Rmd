...
mod.2 <- glmer(Tracheostomy~score_lasso2 + (1|center), data = trach_df_long2, family = "binomial")# , control = glmerControl(optCtrl = list(maxfun = 1000)))
...
On the test data, there were no major differences between the predictive model's for predicting tracheostomy placement using 36 weeks and 44 data. The 36 weeks model achieved slightly highere metrics compared to the 44 weeks model as  indicated in Table 4.
